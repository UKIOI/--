...
当前游戏版本：**0.1.4**。首页点击 **更新日志 · v0.1.4** 查看本次更新和此前功能回顾。
...
Ctrl+A 或「全部接管」按钮可接管全部已落稳攻击塔。地底裂隙现在针对阵地造成破土冲击，裂缝持续 3 秒，虫群从空隙出土。新增精英「地渊孵化兽」：6 分钟后进入刷怪池，预警 4 秒后从建筑底部钻出，首批释放 6 只虫，之后每 8 秒孵化 3 只；生命 2200、护甲 15%、场上最多 2 只，随难度与时间成长。优先摧毁本体可停止增援。
